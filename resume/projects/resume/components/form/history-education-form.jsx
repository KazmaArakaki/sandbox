...
export default class Component extends React.Component {
  constructor(props) {
    ...
    this.state = {
      "doShowModal": false,
      "selectedHistoryKey": "",
      "histories": JSON.parse(this.props.app.getDataFromStorage("history_education")) || []
    };
  }
  ...
  componentDidUpdate() {
    this.props.app.setDataToStorage("history_education", JSON.stringify(this.state.histories));
  ...
  render() {
    ...
    return (
      <div className={cr("container")}
        ...
        <p className={cr("note")}>
          入力された学歴はご利用の端末に保存され、個人情報が自動的にアップロードされることはありません。
        </p>
